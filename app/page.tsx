          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                bar: 'bg-teal-500',
                title: 'Volunteer',
                body: 'Mentor a scholar, coordinate events, or speak at a Baatein session. Just 2 hours/month changes a life.',
                cta: 'Register Now',
              ...
              },
              {
                ...
                bar: 'bg-navy-700',
                title: 'Partner (CSR)',
                body: 'Name a scholarship, sponsor Pratibha Poshan, or fund Baatein. Full transparency, quarterly reports, 80G receipts.',
                cta: 'Partner With Us',
