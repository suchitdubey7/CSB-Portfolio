...
const WA_NUMBER = '919930287551'
const WA_MESSAGE = encodeURIComponent(
  'Hi! I came across Chinmaya Smiles Back and would like to know more.'
)
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span
        className={`
          bg-white text-slate-700 text-sm font-medium px-4 py-2 rounded-xl shadow-lg border border-slate-100
